...
public class CassandraJoins {
    ...
    private static Map<String, TimeKeeper> _times = new HashMap<>();
    ...
    private static boolean IsIndexedColumn(Cluster ClusterConn, String KeySpace, String tableName, String columnName) throws CassandraJoinsException {
        ...
        if (ClusterConn.getMetadata().getKeyspace(KeySpace).getTable(tableName).getColumn(columnName).getIndex() != null) {
            return true;
        }
    ...
    private static void addToMap(String key, TimeKeeper keeper)
    {
        _times.put(key, keeper);
    }
    
    public static Map<String, TimeKeeper> getTimes()
    {
        return _times;
    }
}
